...
public enum Spritesheets {
    ...
    Player(1,new SpriteAnimation(new ImageView(new Image("assets/player.png")), 8, 8, 0, 0, 94, 41, Duration.millis(1000))),
    Player2(1,new SpriteAnimation(new ImageView(new Image("assets/player2.png")), 8, 8, 0, 0, 94, 41, Duration.millis(1000))),
