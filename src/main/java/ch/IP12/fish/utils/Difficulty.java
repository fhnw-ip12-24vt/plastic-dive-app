...
public enum Difficulty {
    Easy("Baumwolle – Natürlich, aber ressourcenintensiv\n" +
            "\n" +
            "Baumwolle ist eine beliebte Naturfaser, die weich und biologisch abbaubar ist. Doch ihre Produktion hat Schattenseiten: Der Anbau benötigt enorme Wassermengen (bis zu 2.700 Liter pro Shirt) und große Mengen Chemikalien, die Böden und Gewässer belasten.\n" +
            "\n" +
            "Alternativen wie Bio-Baumwolle setzen auf umweltfreundlichere Methoden. Durch bewusstes Konsumieren und Recycling kann jeder helfen, den ökologischen Fußabdruck von Baumwollprodukten zu verringern.", 7624841656535L),
    Medium("Mischfasern - Beim Waschen besonders problematisch\n" +
            ...
            "Um die Belastung zu verringern, hilft es, Mischfaser-Kleidung seltener zu waschen und nachhaltigere Alternativen zu wählen.", 6211734858498L),
    Hard("Polyester - Praktisch, aber problematisch\n" +
            ...
            "Recycling-Polyester und ein bewusster Umgang mit Kleidung können helfen, die Umweltauswirkungen zu reduzieren.", 7751064387955L);
